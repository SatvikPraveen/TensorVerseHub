...
class TestPositionalEncoding:
    ...
    def test_get_angles(self):
        ...
        assert not np.allclose(
            angles[0], angles[1]
        )  # Different positions should have different angles
...
@pytest.mark.parametrize("d_model,num_heads", [(32, 4), (64, 8), (128, 16), (256, 32)])
...
@pytest.mark.parametrize("position,d_model", [(50, 32), (100, 64), (200, 128), (500, 256)])
